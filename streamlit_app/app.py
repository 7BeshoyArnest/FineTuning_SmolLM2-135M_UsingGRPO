...
# -----------------------------
# Fixed port for FastAPI
# -----------------------------
FASTAPI_PORT = 8000
API_URL = f"http://127.0.0.1:{FASTAPI_PORT}/generate"
...
# UI Header
# -----------------------------
st.title("🚀 GRPO-Fine-Tuned SmolLM2")
st.write(
...
if st.button("Generate Response"):
    if prompt.strip() == "":
        ...
        if wait_for_fastapi(f"http://127.0.0.1:{FASTAPI_PORT}/health"):
            try:
